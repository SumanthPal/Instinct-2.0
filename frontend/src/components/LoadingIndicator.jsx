export default function LoadingIndicator({ hasMore, loading }) {
  ...
  return (
    <div className="text-center mt-6 sm:mt-8">
      <div className="inline-block px-4 sm:px-6 py-2 sm:py-3 backdrop-blur-xs bg-white/30 dark:bg-dark-card/30 rounded-full border border-white/20 dark:border-dark-text/10 shadow-md text-sm sm:text-base">
        {loading ? (
