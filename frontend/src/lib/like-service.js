...
export const likesService = {
  ...
  async isClubLiked(instagramHandle) {
    ...
    const handle =
      typeof instagramHandle === "object"
        ? instagramHandle.instagram
        : instagramHandle;

    if (!handle) {
      console.warn(
        "Could not determine instagram handle from:",
        instagramHandle,
      );
      return false;
    }
  ...
  async toggleLikeClub(instagramHandle) {
    ...
    if (!handle) {
      console.error(
        "Instagram handle is missing for toggleLikeClub. Received:",
        instagramHandle,
      );
